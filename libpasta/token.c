...
struct tokeninfo tokens[] = {
    ...
    TOKENINFO(TOK_FOR),
    TOKENINFO(TOK_GOTO),
    TOKENINFO(TOK_GREATEQL),
    TOKENINFO(TOK_GREATER),
    TOKENINFO(TOK_IDENTIFIER),
    TOKENINFO(TOK_IF),
    TOKENINFO(TOK_IN),
    TOKENINFO(TOK_LBRACKET),
    TOKENINFO(TOK_LESSEQL),
    TOKENINFO(TOK_LESSER),
    TOKENINFO(TOK_LPAREN),
    TOKENINFO(TOK_MINUS),
    TOKENINFO(TOK_MOD),
    TOKENINFO(TOK_NEQUAL),
    TOKENINFO(TOK_NIL),
    TOKENINFO(TOK_NOT),
    TOKENINFO(TOK_OF),
    TOKENINFO(TOK_OR),
    TOKENINFO(TOK_PACKED),
    TOKENINFO(TOK_PLUS),
...
struct keyword keywords[] = {
    ...
    {"downto", TOK_DOWNTO}, {"else", TOK_ELSE},
    {"end", TOK_END},       {"exit", TOK_EXIT},
    {"file", TOK_FILE},     {"for", TOK_FOR},
